...
rb = open_workbook("data_list.xls")
wb = copy(rb)

sheet1 = wb.get_sheet(0)

for ch in range(1, 8):  # ch denotes the number of characters or hexadecimal digits to be compared
    ...
    for i in range(10):
        ...
        for j in range(count):
            collission = [0] * (2 ** (4 * ch))  # initialising the list elements with 0
            ...
            while 1:
                ...
                if collission[int(hashstr, 16)] == 1:  # checks if the string had been generated earlier
                    ...
                    collission[int(hashstr, 16)] = 1  # flag the new digest as 1
